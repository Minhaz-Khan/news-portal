...
const allListDisplay = (allNewsList) => {
    ...
    newsListContainer.innerHTML = `
       <div class="row  p-4 justify-content-around fw-semibold">
            <a class=" col-md col-4  text-center pe-auto cursor-set" onclick="getAllNewsData(${allNewsList[0].category_id},'${allNewsList[0].category_name}')">${allNewsList[0].category_name}</a>
            <a class=" col-md col-4 text-center pe-auto cursor-set" onclick="getAllNewsData(${allNewsList[1].category_id},'${allNewsList[1].category_name}')">${allNewsList[1].category_name}</a>
            <a class=" col-md col-4 text-center pe-auto cursor-set" onclick="getAllNewsData(${allNewsList[2].category_id},'${allNewsList[3].category_name}')">${allNewsList[3].category_name}</a>
            ...
            <a class=" col-md col-4 text-center pe-auto cursor-set" onclick="getAllNewsData(${allNewsList[5].category_id},'${allNewsList[5].category_name}')">${allNewsList[5].category_name}</a>
            <a class=" col-md col-4 text-center pe-auto cursor-set" onclick="getAllNewsData(${allNewsList[6].category_id},'${allNewsList[6].category_name}')">${allNewsList[6].category_name}</a>
            <a class=" col-md col-4 text-center pe-auto cursor-set" onclick="getAllNewsData(${allNewsList[7].category_id},'${allNewsList[7].category_name}')">${allNewsList[7].category_name}</a>
       </div>
    `
}
    ...
    <div class=" row g-0 p-3">
        ...
        <div class="col-md-8 col-12">
            ...
            <div class="ms-3 d-flex align-items-center justify-content-between"> 
                ...
                <button class="btn btn-primary px-3" onclick="openModal('${news._id}')" data-bs-toggle="modal" data-bs-target="#exampleModal">Details</button>
            </div>
    </div>
        `
...
const displayNewsDetails = (news) => {
    ...
    modalBody.innerHTML = `
    <div>
        <img src="${news.image_url} " class="w-100"></img>
    </div>
